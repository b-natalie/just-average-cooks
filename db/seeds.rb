...
ri1 = (recipe_id: r1.id, ingredient_id: i1.id, quantity: "1/2 head")
ri2 = (recipe_id: r1.id, ingredient_id: i2.id, quantity: "4 teaspoons")
ri3 = (recipe_id: r1.id, ingredient_id: i3.id, quantity: "1 teaspoon")
ri4 = (recipe_id: r1.id, ingredient_id: i4.id, quantity: "1 teaspoon")
ri5 = (recipe_id: r1.id, ingredient_id: i5.id, quantity: "3/4 cup")
ri6 = (recipe_id: r1.id, ingredient_id: i6.id, quantity: "to taste")
ri7 = (recipe_id: r1.id, ingredient_id: i7.id, quantity: "8")
ri8 = (recipe_id: r1.id, ingredient_id: i8.id, quantity: "1 head")
ri9 = (recipe_id: r1.id, ingredient_id: i16.id, quantity: "1")

ri10 = (recipe_id: r3.id, ingredient_id: i9.id, quantity: "1 small")
ri11 = (recipe_id: r3.id, ingredient_id: i10.id, quantity: "1")
ri12 = (recipe_id: r3.id, ingredient_id: i11.id, quantity: "1/4 cup")
ri13 = (recipe_id: r3.id, ingredient_id: i12.id, quantity: "1 cup")
ri14 = (recipe_id: r3.id, ingredient_id: i13.id, quantity: "1 teaspoon")
ri15 = (recipe_id: r3.id, ingredient_id: i14.id, quantity: "1")
ri16 = (recipe_id: r3.id, ingredient_id: i15.id, quantity: "1/2 teaspoon")
ri17 = (recipe_id: r3.id, ingredient_id: i16.id, quantity: "2")